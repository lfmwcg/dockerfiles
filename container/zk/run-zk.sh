...
docker exec -it k1 /bin/bash /usr/local/zookeeper/bin/zkServer.sh start
docker exec -it k2 /bin/bash /usr/local/zookeeper/bin/zkServer.sh start
docker exec -it k3 /bin/bash /usr/local/zookeeper/bin/zkServer.sh start
